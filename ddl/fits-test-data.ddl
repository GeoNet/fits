...
select fits.add_observation('TEST1', 'TN1', 't1', 'm1', 'none', 'none', '2000-01-06T12:00:00.000000Z'::timestamptz, 1.52, 0);
select fits.add_observation('TEST1', 'TN1', 't1', 'm1', 'none', 'none',  '2000-01-07T12:00:00.000000Z'::timestamptz, 2.52, 0);
select fits.add_observation('TEST1', 'TN1', 't1', 'm2', 'none', 'none',  '2000-01-08T12:00:00.000000Z'::timestamptz, 3.52, 0);
-- Add an observation and update it.
select fits.add_observation('TEST1', 'TN1', 't1', 'm1', 'none', 'none',  '2000-01-09T12:00:00.000000Z'::timestamptz, 3.52, 0);
select fits.add_observation('TEST1', 'TN1', 't1', 'm1', 'none', 'none',  '2000-01-09T12:00:00.000000Z'::timestamptz, 4.52, 1.1);
-- Add observation at same site, same type, same time but different method.
select fits.add_observation('TEST2', 'TN1', 't1', 'm1', 'none', 'none',  '2000-01-08T12:00:00.000000Z'::timestamptz, 4.52, 1.1);
select fits.add_observation('TEST2', 'TN1', 't1', 'm2', 'none', 'none',  '2000-01-08T12:00:00.000000Z'::timestamptz, 4.02, 0.1);
-- Add some observations for sample 0001.
select fits.add_observation('TEST2', 'TN1', 't1', 'm2', '0001', 'lab',  '2001-01-08T12:00:00.000000Z'::timestamptz, 9.02, 0.1);
select fits.add_observation('TEST2', 'TN1', 't1', 'm1', '0001', 'lab',  '2001-01-08T12:00:00.000000Z'::timestamptz, 9.12, 0.01);
select fits.add_observation('TEST2', 'TN1', 't2', 'm1', '0001', 'lab',  '2001-01-08T12:00:00.000000Z'::timestamptz, 9.12, 0.01);

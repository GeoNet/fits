...
# Restart postgres.
#
dropdb --host=127.0.0.1 --username=$db_user dapper
...
psql --host=127.0.0.1 -d dapper --username=$db_user -c 'create extension postgis;'

psql --host=127.0.0.1 --quiet --username=$db_user --dbname=dapper --file=${ddl_dir}/create-table.ddl

...
func observationStats(w http.ResponseWriter, r *http.Request) {
	...
	stats.First = ObsValue{DateTime: firstVal.T.Format(time.RFC3339),
		Value: firstVal.V,
		Error: firstVal.E}

	stats.Last = ObsValue{DateTime: lastVal.T.Format(time.RFC3339),
		Value: lastVal.V,
		Error: lastVal.E}
	...
	stats.Minimum = ObsValue{DateTime: minVal.T.Format(time.RFC3339),
		Value: minVal.V,
		Error: minVal.E}

	stats.Maximum = ObsValue{DateTime: maxVal.T.Format(time.RFC3339),
		Value: maxVal.V,
		Error: maxVal.E}
